...
export default function NewsContent() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (data.length === 0) {
                    const response = await axios.get("https://newsapi.org/v2/everything?q=apple&from=2024-02-17&to=2024-02-17&sortBy=popularity&apiKey=cb0ead5c7bb142d3bc5c9470fc8ad3b2");

                    // const response = await axios.get("https://newsapi.org/v2/everything?q=tesla&from=2024-01-16&sortBy=publishedAt&apiKey=a9fca0a363f04b0ebde2adef74548d94");
