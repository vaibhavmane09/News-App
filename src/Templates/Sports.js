        ...
        const fetchData = async () => {
            try {
                if (data.length === 0) {
					...
					const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=cb0ead5c7bb142d3bc5c9470fc8ad3b2");

					// const response = await axios.get("https://newsapi.org/v2/everything?q=sports&from=2024-01-16&sortBy=publishedAt&apiKey=cb0ead5c7bb142d3bc5c9470fc8ad3b2");
