...
export default function NewsContent() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (data.length === 0) {
					// const response = await axios.get("https://newsapi.org/v2/everything?q=govt&from=2024-01-16&sortBy=publishedAt&apiKey=a9fca0a363f04b0ebde2adef74548d94");

                    const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=cb0ead5c7bb142d3bc5c9470fc8ad3b2");
    ...
    return (
        <div className='d-flex flex-column justify-content-start'>
            ...
            <div className="container d-flex gap-3 justify-content-evenly flex-wrap" style={{ marginTop: "3%", width: "100%" }}>
                <h3 className="w-100 m-0 p-0 text-white opacity-75"><u>Top Headlines:</u> Science & Technology</h3>
