...
export default function NewsContent() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (data.length === 0) {
                    const response = await axios.get("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=315378cffe33400baacf6e91a84f902a");
    ...
    return (
        <div className='d-flex flex-column justify-content-start'>
            ...
            <div className="container d-flex gap-3 justify-content-evenly flex-wrap" style={{ marginTop: "3%", width: "100%" }}>
                <h3 className="w-100 m-0 p-0 text-white opacity-75"><u>Top Headlines:</u> Entertainment</h3>
